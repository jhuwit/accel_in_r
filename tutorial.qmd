...
# We're not using calibrated data here
...
[`MIMSunit`](https://github.com/mhealthgroup/mimsunit) package - calculate MIMS unit [@mims]:
 - interpolation of the signal to 100Hz, 
 - extrapolate signal for regions that have hit the maximum/minimum acceleration units for the devic
...
The main elements of interest are the `data.frame` of estimated steps, which has the associated timestamps:
